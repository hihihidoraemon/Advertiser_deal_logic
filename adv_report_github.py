...
GITHUB_TEMPLATE_URL = "https://raw.githubusercontent.com/your-username/your-repo/main/adv_report_template.xlsx"
# 页面基础配置
st.set_page_config(
    page_title="广告数据分析工具",
    page_icon="📊",
        ...
        try:
            ...
            if st.button("🚀 开始分析", type="primary"):
                with st.spinner("正在执行数据分析..."):
                     ...
                     with pd.ExcelWriter(os.path.join(output_dir, "日报计算汇总.xlsx"), engine="openpyxl") as writer:
